...
public class MainActivity extends AppCompatActivity {
    ...
    private ProgressBar mFetchWeatherDataProgressBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFetchWeatherDataProgressBar = (ProgressBar) findViewById(R.id.pb_fetch_weather_data);
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPreExecute() {
            mFetchWeatherDataProgressBar.setVisibility(View.VISIBLE);
            super.onPreExecute();
        }
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            mFetchWeatherDataProgressBar.setVisibility(View.INVISIBLE);
