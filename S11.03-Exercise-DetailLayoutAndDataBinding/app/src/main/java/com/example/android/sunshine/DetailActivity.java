...
public class DetailActivity extends AppCompatActivity implements
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        mDetailBinding.weatherPrimary.date.setText(dateText);
        ...
        mDetailBinding.weatherExtra.humidityValue.setText(humidityString);
        mDetailBinding.weatherExtra.humidityValue.setContentDescription(humidityA11y);

        // COMPLETED (19) Set the content description of the humidity label to the humidity a11y String
        mDetailBinding.weatherExtra.humidityLabel.setContentDescription(humidityA11y);
        ...
        mDetailBinding.weatherExtra.windValue.setContentDescription(widnA11y);

        // COMPLETED (22) Set the content description of the wind label to the wind a11y String
        mDetailBinding.weatherExtra.windLabel.setContentDescription(widnA11y);
        ...
        mDetailBinding.weatherExtra.pressureValue.setContentDescription(pressureA11y);

        // COMPLETED (24) Set the content description of the pressure label to the pressure a11y String
        mDetailBinding.weatherExtra.pressureLabel.setContentDescription(pressureA11y);
